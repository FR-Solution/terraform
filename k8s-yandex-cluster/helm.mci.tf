...
#         zone = "ru-central1-a" 
#         k8s_api_server_fqdn         = module.kubernetes.k8s_global_vars.k8s-addresses.kube_apiserver_lb_fqdn
#         k8s_api_server_port         = module.kubernetes.k8s_global_vars.kubernetes-ports.kube-apiserver-port-lb
